...
class MimeNode {
    ...
    parseHeaders() {
        ...
        if (this._parsedContentDisposition.params.format && this._parsedContentDisposition.params.format.toLowerCase().trim() === 'flowed') {
            this.flowed = true;
            if (this._parsedContentDisposition.params.delsp && this._parsedContentDisposition.params.delsp.toLowerCase().trim() === 'yes') {
                this.delSp = true;
            }
        }
    ...
    setContentType(contentType) {
        ...
        if (!this.flowed && this._parsedContentDisposition.params.format) {
            delete this._parsedContentDisposition.params.format;
        }
        if (!this.delSp && this._parsedContentDisposition.params.delsp) {
            delete this._parsedContentDisposition.params.delsp;
        }
